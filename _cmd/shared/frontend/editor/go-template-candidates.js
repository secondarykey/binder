...
export const goTemplateCandidates = [
  ...
  { label: 'childrenNotes', detail: 'autocomplete.childNotes', category: 'binder', args: [{ name: 'n?', type: 'int' }, { name: 'id?', type: 'string' }, { name: 'order?', type: 'string' }], returns: '[]Note', deprecated: true },
