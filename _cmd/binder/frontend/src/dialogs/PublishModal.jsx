 ...
 */
function PublishModal({ open, template, subtreeData, onClose }) {
  ...
  const title = template ? t("template.batchPublishTitle") : subtreeData ? t("tree.publishSubtree") : t("publishModal.title");
  ...
  return (
    ...
    >
      <div id="commitArea">
        <div id="commitLeft">
          <UnpublishedMenu date={date} template={template} subtreeData={subtreeData} onClose={onClose} />
        </div>
        <div id="commitRight">
          <div id="commitForm">
